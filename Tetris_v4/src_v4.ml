...
let tetris_v2():unit = 
  ...
  let init:t_param = {size_x = 10; size_y = 20; dilat = 25; tick = ref 0.5; is_on_floor = ref false; main_shape = ref {position = (0,1); color = red; shape = square}};

  in
      open_graph(init);
      drop_shape(horizontal_bar, red, 5, init);
