...
let drop_shape(p_nb, p_param:int*t_param) = 
  for i = 1 to p_nb do
...
let tetris_v5():unit = 
  ...
  let init:t_param = {size_x = 10; size_y = 20; dilat = 25; tick = ref 0.5; is_on_floor = ref false; main_shape = ref {position = (0,1); color = red; shape = square}; border = 20; shapes = [|horizontal_bar; vertical_bar; square|]; colors = [|green; yellow; orange; blue; red; magenta; cyan|]};
